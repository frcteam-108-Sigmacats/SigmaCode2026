...
//  *
//  * <p>Naming convention mirrors {@link DriveCommands}: every method returns a {@link Command} and
// is
...
//   /**
//    * Immediately cut power to every motor on the turret subsystem and coast to a stop. This
// command
...
//    *
//    * <p>Applies a deadband and squares the input for finer control near centre. Safe to use as
// the
...
//   /**
//    * Spin the shooter wheels to {@code targetMPS} surface speed and keep running until
// interrupted.
...
//   /**
//    * Servo the hood to a fixed angle and finish once the hood is within tolerance. Times out
// after 2
...
//   /**
//    * Simultaneously spin the shooter wheels and servo the hood to the requested positions.
// Finishes
//    * once both the wheels are at speed <em>and</em> the hood is at the target angle. Times out
// after
//    * 3 seconds.
//    *
