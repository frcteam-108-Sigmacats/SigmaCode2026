...
/**
 * Tracks the alliance's Reef hub using the Limelight and rotates the robot to face it while still
 ...
 * </ul>
 *
 * <p>The Limelight is told to prioritise the nearest alliance tag so the robot always locks on to
...
public class TrackHubCommand extends Command {
  ...
  /**
   * Returns the set of Reef AprilTag IDs that belong to the robot's current alliance. Falls back to
