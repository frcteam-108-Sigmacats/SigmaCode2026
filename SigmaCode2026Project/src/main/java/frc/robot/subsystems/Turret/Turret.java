...
/**
 * Turret subsystem – owns the turret rotation, shooter flywheels, and hood.
 *
 * <p>Hardware (real robot):
 * <ul>
 *   <li>1× Neo Vortex (SparkFlex) – turret yaw ring
 *   <li>2× Kraken X60 (TalonFX)  – shooter wheels
 *   <li>1× Neo 550 (SparkMax)    – hood angle
 * </ul>
 *
 * <p>Construct with the appropriate {@link TurretIO} implementation:
 * <pre>
 *   // Simulation
 *   new Turret(new TurretIOSim());
 *
 *   // Real robot – full competition config (absolute encoder on turret)
 *   new Turret(new TurretIOReal());
 *
 *   // Real robot – mixed vendor config (relative encoder on turret)
 *   new Turret(new TurretIOMix());
 * </pre>
 */
